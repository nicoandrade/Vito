<?php
//Comments Function
if ( ! function_exists( 'ql_comment' ) ){
	function ql_comment($comment, $args, $depth) {
     ...
     <div id="comment-<?php comment_ID(); ?>" class="comment">
      ...
      <div class="comment_wrap col-md-10 col-sm-9">
            ...
            <div class="comment-meta commentmetadata">
                ...
                <time datetime="<?php echo get_comment_date('c') ?>" pubdate><?php printf(__('%1$s at %2$s', 'eneaa'), get_comment_date(),  get_comment_time()) ?></time>
                </a>
                <?php edit_comment_link(__('(Edit)', 'eneaa'),'  ','') ?>
              </div>
